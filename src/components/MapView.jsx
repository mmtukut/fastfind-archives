    ...
    <div className="fixed inset-0 bg-white z-40">
      ...
      <div className="bg-white shadow-sm sticky top-[72px] z-10 border-b">
        <div className="container mx-auto px-4">
          <div className="flex items-center gap-3 py-2">
            <div className="flex-1 relative">
              <input
                ...
                className="w-full pl-9 pr-4 py-2 text-sm border border-gray-200 rounded-full focus:outline-none focus:ring-2 focus:ring-[#1c5bde]/20 focus:border-[#1c5bde]"
              />
            ...
            <motion.button
              ...
              className="bg-[#1c5bde] text-white px-4 py-2 text-sm rounded-full flex items-center gap-1.5 hover:bg-[#0c0d8a] transition-colors"
            >
          ...
          <div className="py-1.5 -mx-4 px-4 overflow-x-auto scrollbar-hide">
